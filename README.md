...
> 🛠️ **开发工具**: 本项目使用 **Claude Code** 与 **小米 MiMo 大模型** 协作开发完成
...
```bash
# 1. 克隆仓库
git clone https://github.com/Wangfugui1799/tancise.git

# 2. 进入目录
cd tancise

# 3. 启动游戏
# 方法 A: 直接双击打开 index.html
# 方法 B: 或者使用本地服务器
...
### 🌐 在线访问
如果已启用 GitHub Pages：
[https://wangfugui1799.github.io/tancise/](https://wangfugui1799.github.io/tancise/)
